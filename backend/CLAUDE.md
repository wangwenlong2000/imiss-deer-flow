...
- **Frontend** (port 23975): Next.js web interface
- **Nginx** (port 23976): Unified reverse proxy entry point
...
This starts all services and makes the application available at `http://localhost:23976`.

**Nginx routing**:
- `/api/langgraph/*` → LangGraph Server (2024)
- `/api/*` (other) → Gateway API (8001)
- `/` (non-API) → Frontend (23975)
