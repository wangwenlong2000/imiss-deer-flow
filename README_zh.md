...
然后确认 DeerFlow 已经启动（默认地址是 `http://localhost:23976`），在 Claude Code 里使用 `/claude-to-deerflow` 命令即可。
...
```bash
DEERFLOW_URL=http://localhost:23976            # 统一代理基地址
