...
COMPOSE_CMD=(docker compose -p qwen36test-deer-flow -f "$DOCKER_DIR/docker-compose.yaml")
...
echo "=========================================="
echo ""
echo "  🌐 Application: http://localhost:${PORT:-3538}"
echo "  📡 API Gateway: http://localhost:${PORT:-3538}/api/*"
echo "  🤖 LangGraph:   http://localhost:${PORT:-3538}/api/langgraph/*"
echo ""
echo "  Manage:"
