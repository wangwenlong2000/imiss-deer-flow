...
Assurez-vous ensuite que DeerFlow tourne (par défaut sur `http://localhost:23976`) et utilisez la commande `/claude-to-deerflow` dans Claude Code.
...
```bash
DEERFLOW_URL=http://localhost:23976            # Unified proxy base URL
DEERFLOW_GATEWAY_URL=http://localhost:23976    # Gateway API
DEERFLOW_LANGGRAPH_URL=http://localhost:23976/api/langgraph  # LangGraph API
```
