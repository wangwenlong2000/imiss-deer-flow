...
#   DEERFLOW_URL          — Unified proxy base URL (default: http://localhost:23976)
...
DEERFLOW_URL="${DEERFLOW_URL:-http://localhost:23976}"
...
gateway_url = sys.argv[2].rstrip("/") if len(sys.argv) > 2 else "http://localhost:23976"
