...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the event-template-mapping video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="event-template-mapping-run")
    ...
    result = EventTemplateMappingSkill().run(input_data, context)
