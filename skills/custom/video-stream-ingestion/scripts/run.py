...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the video-stream-ingestion video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="video-stream-ingestion-run")
    ...
    result = VideoStreamIngestionSkill().run(input_data, context)
