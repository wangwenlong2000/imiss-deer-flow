...
from trajectory_preprocess_lib import clean_points, extract_staypoints, load_points, write_jsonl


def main() -> int:
    parser = argparse.ArgumentParser(description="Extract staypoints from trajectory data.")
    ...
    payload = {
        ...
        "output": str(output_dir / "staypoints.jsonl"),
