...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the evidence-snapshot video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="evidence-snapshot-run")
    ...
    result = EvidenceSnapshotSkill().run(input_data, context)
