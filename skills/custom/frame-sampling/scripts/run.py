...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the frame-sampling video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="frame-sampling-run")
    ...
    result = FrameSamplingSkill().run(input_data, context)
