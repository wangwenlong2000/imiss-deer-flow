...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the duplicate-event-merge video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="duplicate-event-merge-run")
    ...
    result = DuplicateEventMergeSkill().run(input_data, context)
