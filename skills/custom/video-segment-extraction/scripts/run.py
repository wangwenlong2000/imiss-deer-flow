...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the video-segment-extraction video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="video-segment-extraction-run")
    ...
    result = VideoSegmentExtractionSkill().run(input_data, context)
