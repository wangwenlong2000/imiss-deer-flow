...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the object-composition-event video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="object-composition-event-run")
    ...
    result = ObjectCompositionEventSkill().run(input_data, context)
