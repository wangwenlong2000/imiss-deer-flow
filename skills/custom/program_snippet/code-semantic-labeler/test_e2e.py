...
# 配置路径
sys.path.insert(0, '/mnt/skills/custom/program_snippet/code-semantic-labeler')
sys.path.insert(0, '/mnt/skills/custom/program_snippet/code-semantic-labeler/scripts')
os.environ['DEER_FLOW_CONFIG_PATH'] = '/mnt/skills/custom/program_snippet/code-semantic-labeler/config.yaml'
...
with open('/mnt/skills/custom/program_snippet/code-semantic-labeler/ontology_rules.json', 'r') as f:
    rules = json.load(f)
