...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the density-aggregation-event video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="density-aggregation-event-run")
    ...
    result = DensityAggregationEventSkill().run(input_data, context)
