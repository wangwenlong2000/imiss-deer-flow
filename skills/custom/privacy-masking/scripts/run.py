...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the privacy-masking video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="privacy-masking-run")
    ...
    result = PrivacyMaskingSkill().run(input_data, context)
