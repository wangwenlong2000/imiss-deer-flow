...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the object-tracking video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="object-tracking-run")
    ...
    result = ObjectTrackingSkill().run(input_data, context)
