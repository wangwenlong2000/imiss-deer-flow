...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the spatial-occupancy-event video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="spatial-occupancy-event-run")
    ...
    result = SpatialOccupancyEventSkill().run(input_data, context)
