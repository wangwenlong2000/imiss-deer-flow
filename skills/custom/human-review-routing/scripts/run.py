...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the human-review-routing video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="human-review-routing-run")
    ...
    result = HumanReviewRoutingSkill().run(input_data, context)
