...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the object-detection video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="object-detection-run")
    ...
    result = ObjectDetectionSkill().run(input_data, context)
