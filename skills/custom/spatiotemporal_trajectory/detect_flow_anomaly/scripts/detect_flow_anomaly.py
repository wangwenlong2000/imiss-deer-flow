...
COMMON = Path(__file__).resolve().parent / "_trajectory_common"
...
def main() -> int:
    ...
    parser.add_argument("--input", required=True, help="Input region_heat.jsonl, od_matrix.jsonl, or trajectory evidence JSONL")
