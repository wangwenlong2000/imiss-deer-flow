...
1. `04A-权利要求布局卡-<方案名>.md`
2. `04B-权利要求-代码证据矩阵-<方案名>.md`
...
将方法中的关键步骤映射为模块、单元、组件或执行器，但不要机械改写为“用于……的模块”列表。必须体现模块之间的配合关系和数据交互关系。
...
5. 摘要是否符合长度和表达要求
6. 计算机程序相关方案是否区分了方法口径与产品口径，且没有把抽象功能直接当作技术方案
7. 是否误把第三方固有能力或 C 级证据写成申请人的既有实现
8. 是否显式列出待代理师 / 研发确认事项
