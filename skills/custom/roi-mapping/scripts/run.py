...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the roi-mapping video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="roi-mapping-run")
    ...
    result = ROIMappingSkill().run(input_data, context)
