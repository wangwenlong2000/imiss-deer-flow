...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the event-rule-engine video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="event-rule-engine-run")
    ...
    result = EventRuleEngineSkill().run(input_data, context)
