...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the camera-health-check video monitoring skill.")
    ...
    parser.add_argument("--trace-id", default="camera-health-check-run")
    ...
    result = CameraHealthCheckSkill().run(input_data, context)
