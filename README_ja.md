...
DeerFlowが実行中であることを確認し（デフォルトは`http://localhost:23976`）、Claude Codeで`/claude-to-deerflow`コマンドを使用します。
...
```bash
DEERFLOW_URL=http://localhost:23976            # 統合プロキシベースURL
