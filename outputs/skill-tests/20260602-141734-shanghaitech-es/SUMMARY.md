...
- started_at: `2026-06-02T14:17:34+0800`
- finished_at: `2026-06-02T14:18:01+0800`
...
- agent_chain_passed: `1/1`
- functional_success: `0/1`

## Results

| Case | Skill | Agent Chain | Result | Error | Notes |
| --- | --- | --- | --- | --- | --- |
| `video-embedding-index-streetmodel-video` | `video-embedding-index` | `True` | `failed` | `STREETMODEL_REQUEST_FAILED` | {} |
