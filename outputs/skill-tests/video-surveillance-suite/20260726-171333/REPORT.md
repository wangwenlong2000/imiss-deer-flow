...
| A2 | 交警调阅请求 -> video-search，不误入事件分析 | fail | video_asset_retrieval |
...
| A5 | 越界能力请求 -> capability_gap / 护栏 | pass | {"capability": "camera_health_operations", "capability_gap": {"supported": "partial", "gaps": ["Real-time stream connection is not covered by current local-vide |
